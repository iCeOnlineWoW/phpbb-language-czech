...
$lang = array_merge($lang, array(
	...
	'ALLOWED_SCHEMES_LINKS'				=> 'Povolit schématované odkazy',
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'		=> 'Uživatelé mohou přidávat pouze schématované odkazy.',
...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'Zde lze definovat obsah dat obsažených v&nbsp;cookies odesíláných prohlížečům návštěvníků. Ve většině případů by výchozí hodnoty měly bez potíží vyhovovat. Pokud je však třeba některé upravit, buďte opatrní; jejich špatné nastavení může zabránit uživatelům v&nbsp;přihlášení. Pokud máte přetrvávající problém s přihlašováním, podívejte se do <b><a href="https://www.phpbb.com/support/go/cookie-settings/">phpBB.com Znalostní báze - Oprava nastavení cookies</a></b>.',

	'COOKIE_DOMAIN'				=> 'Doména cookie',
	'COOKIE_DOMAIN_EXPLAIN'		=> 'Ve většině případů není nutné tuto hodnotu nastavovat.<br /><br /> V případě, že potřebujete cookies sdílet s dalšími subdoménami, zadejte do pole hodnotu <i>.example.com</i>.',
	'COOKIE_NAME'				=> 'Název cookie',
	'COOKIE_NAME_EXPLAIN'		=> 'Zde si můžete zvolit název pro cookies. Pokud dojde ke změně nastavení cookies, měl by být změněn i název.',
	...
	'COOKIE_PATH_EXPLAIN'		=> 'Zde je vždy znak / nezávisle na vaší adrese fóra.',
...
$lang = array_merge($lang, array(
  ...
  'LOAD_CPF_PM'					=> 'Zobrazit vlastní pole profilu v soukromých zprávách',
	...
	'LOAD_USER_ACTIVITY_LIMIT'		=> 'Limit aktivity uživatele',
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'	=> 'Aktivní fóra / témata se nezobrazí uživatelům s počtem příspěvků větším než uvedená hodnota. Pro vypnutí funkce zadejte 0.',
...
$lang = array_merge($lang, array(
	...
	'SMTP_ALLOW_SELF_SIGNED'		=> 'Povolovit automaticky podepsané SSL certifikáty',
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Povolit připojení k SMTP serveru za pomocí automaticky podepsaných SSL certifikátu.<em><strong>Varování:</strong> Povolení může mít velký dopad na zabezpečení.</em>',
	...
	'SMTP_VERIFY_PEER'				=> 'Ověřit SSL certifikát',
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Zde můžete povolit vyžadování ověření SSL certifikátu pro připojení k SMTP serveru.<em><strong>Varování:</strong> Vypnutí může mít velký vliv na zabezpečení.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'Ověřit název připojovatele',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Zde můžete povolit vyžadování ověření názvu připojovatele k SMTP serveru.<em><strong>Varování:</strong> Vypnutí může mít velký vliv na zabezpečení.</em>',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED'			=> 'Povolit automaticky podepsané SSL certifikáty',
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Povolit připojení k Jabber serveru za pomoci automaticky podepsaných SSL certifikátu.<em><strong>Varování:</strong> Povolení může mít velký dopad na zabezpečení.</em>',
	...
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Zde můžete povolit vyžadování ověření SSL certifikátu pro připojení k SMTP serveru.<em><strong>Varování:</strong> Vypnutí může mít velký vliv na zabezpečení.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Ověřit název připojovatele',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Zde můžete povolit vyžadování ověření názvu připojovatele k SMTP serveru.<em><strong>Varování:</strong> Vypnutí může mít velký vliv na zabezpečení.</em>',
));
